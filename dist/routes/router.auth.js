...
import { loginSchema, signUpSchema, } from "../libs/validations/member.validation.js";
import requireRole from "../middleware/role.middleware.js";
import { MemberRole } from "@prisma/client";
const routerAuth = express.Router();
routerAuth.get("/admin", authMiddleware, requireRole(MemberRole.ADMIN), (req, res) => {
...
routerAuth.get("/test", authMiddleware, (req, res) => {
    res.send("OK");
});
